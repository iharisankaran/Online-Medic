...
# creating the frames in the window
        self.main = Frame(window, width=700, height=700, bg="lightgrey")
    ...
    def startpage(self):
        ...
        self.heading = Label(self.main, text="Hospital Management System", font=('Centaur 20 bold') ,fg='black',bg="lightgrey",relief=SUNKEN)
        self.heading.place(x=210, y=20)

        # name

        self.name = Label(self.main, text="Patients Name", font=('arial 12 bold'),bg="lightgrey")
        self.name.place(x=0, y=110)

        # age

        self.age = Label(self.main, text="Age", font=('arial 12 bold'),bg="lightgrey")
        self.age.place(x=0, y=155)

        # gender
        Label(self.main, text="Gender", font=('arial 12 bold'),bg="lightgrey").place(x=0, y=210)
        a = Radiobutton(self.main, text="Male" ,padx=20,font="ariel 10 bold", variable=self.v, value=1,bg="lightgrey").place(x=130, y=210)
        b = Radiobutton(self.main, text="Female", padx=20,font="ariel 10 bold", variable=self.v, value=2,bg="lightgrey").place(x=220, y=210)

        # location

        self.time = Label(self.main, text="Location", font=('arial 12 bold'),bg="lightgrey")
        self.time.place(x=0, y=255)

        # phone

        self.phone = Label(self.main, text="Contact Number", font=('arial 12 bold'),bg="lightgrey")
        self.phone.place(x=0, y=300)

        #Hospital

        self.hosp = Label(self.main, text='Hospitals', font=('arial 12 bold'), bg='lightgrey')
        self.hosp.place(x=0, y=355)

        #Specialist

        self.spec = Label(self.main, text='Type', font=('arial 12 bold'), bg='lightgrey')
        self.spec.place(x=400,y=110)

        #Doctor's name

        self.doc_name = Label(self.main, text='Doctor name', font=('arial 12 bold'), bg='lightgrey')
        self.doc_name.place(x=380, y=210)

        #Session

        self.sess = Label(self.main, text='Session', font=('arial 12 bold'), bg='lightgrey').place(x=380, y=300)
        a = Radiobutton(self.main, text='FN', padx=20, font='arial 10 bold', variable=self.v, value=3, bg='lightgrey').place(x=460,y=300)
        b = Radiobutton(self.main, text='AN', padx=20, font='arial 10 bold', variable=self.v, value=4, bg='lightgrey').place(x=520,y=300)
...
# text box for lables
        ...
        self.phone_ent.place(x=140, y=300)

        self.hosp_ent = Entry(self.main,width=30)
        self.hosp_ent.place(x=140, y=355)

        self.spec_ent = Entry(self.main, width=30)
        self.spec_ent.place(x=480, y=110)

        self.doc_name_ent = Entry(self.main, width=30)
        self.doc_name_ent.place(x=500, y=210)
...
# button to perform a command
        ...
        self.submit.place(x=10, y=540)
        self.submit = Button(self.main, text="Meeting link", font="arial 12 bold", width=15, height=2, bg='lightgreen',command=self.open_link)
        self.submit.place(x=255, y=540)
...
#show log
       ...
       #  display the logs in our frame
        ...
        self.logs = Label(self.main, text="Total\n Appointments", font=('arial 10 bold'), fg='black',bg="lightgrey")
        self.logs.place(x=500, y=530)
        self.logs = Label(self.main, text=" " + str(self.final_id), width=8, height=1,relief=SUNKEN).place(x=520, y=570)
...
# funtion to call submit button
    ...
    def open_link(self):
       ...
       webbrowser.open_new('http://meet.google.com/rgk-heok-eih')
